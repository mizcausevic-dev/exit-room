...
const jsonRoutes = ["/api/dashboard/summary", "/api/readiness-lane", "/api/red-flag-map", "/api/board-story", "/api/deal-room", "/api/risk-map", "/api/verification", "/api/sample", "/api/payload"];
